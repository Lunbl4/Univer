...
students_count = len(students) # всего учеников
student = 0 # Первый ученик

while student < students_count:
    x_spis = students_sorted[student] # ключ
    y_spis = sum(grades[student])/len(grades[student]) # значение ключа равное средней оценке
    grades_sredn.update({x_spis : y_spis})
    student += 1
# Итого
else:
    print(grades_sredn)
